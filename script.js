...
$(window).on("scroll", function () {
  ...
  if ($(window).scrollTop() <= down1Position) {
    ...
    $(".navbar ul li").removeClass("dark");
    $(".navbar ul li").addClass("white");
  } else if (
    $(window).scrollTop() > down1Position &&
    $(window).scrollTop() <= down2Position
  ) {
    $(".navbar ul li").addClass("dark");
    ...
    $(window).scrollTop() > down2Position &&
    $(window).scrollTop() <= down3Position
  ) {
    $("#portfolio").addClass("current1");
